...
static const int64 MAX_MONEY = 70000000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1920 / 250; // 1920 blocks found a day.
    }
...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("040184610fa689ad6023690c80f3a49c8f13f8d45b8c857fbcbc6bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51950b4acf21b179c45070ac7b03a9")))
