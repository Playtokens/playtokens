...
uint256 hashGenesisBlock("0x34aa1e2012563dbabc1caf39c7e26ea1d3f216913b036db94cae4328a0b96ff6");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 10); // starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Playtoken Signed Message:\n";
...
static const int64 nTargetTimespan = 45 * 40; // Playtoken: 30 minutes
static const int64 nTargetSpacing = 45; // Playtoken: 45 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal playtoken miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Playtoken", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x34aa1e2012563dbabc1caf39c7e26ea1d3f216913b036db94cae4328a0b96ff6");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Playtoken: Pay with Play Today";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1375816032; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 650152;

        if (fTestNet)
        {
            block.nTime    = 1375816032;
            block.nNonce   = 650152;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x84f776ff23130fee85568eba66b00e7dc8bd8bb5d006e14513fd921accd193b0"));
