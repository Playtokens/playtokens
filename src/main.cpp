...
uint256 hashGenesisBlock("0xe12c2fb44150fee9bf9108c917493ed17c717fe94afad1d9cc168661844de7ab");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe12c2fb44150fee9bf9108c917493ed17c717fe94afad1d9cc168661844de7ab");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Playtoken: Pay with Playtokens";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1375797724; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 457215;

        if (fTestNet)
        {
            block.nTime    = 1375797724;
            block.nNonce   = 457215;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4ca597b8c33846c5055684d0d3309003b542d8446970ef1fe0d692585563e940"));
